...
(function (global) {
  ...
  var T = {
    en: {
      ...
      t6_h: "Thai foot massage (Nuad Tao)",
      t6_p:
        "Lower legs and feet on a comfortable chair, Thai pressure and lines — plus Thai herbal balm or warm packs when available.",
      t7_h: "Herbal compress & heat",
      t7_p:
        "Steamed Thai herbal bundles to warm muscles, ease stiffness, and add an aromatic layer — often paired with massage.",
      prices_h2: "Prices",
      prices_kicker: "Thai massage menu",
      prices_note: "All prices in NIS (₪). Please confirm current rates when booking.",
      ...
      img_t6_alt: "Feet in a warm soak bowl — Thai foot spa",
      img_t7_alt: "Hands using Thai herbal compress balls on the back",
    },
    he: {
      ...
      about_p1:
        "בסבאי די, רחוב בן סירא 3 בירושלים, Sabai Dee (สบายดี) הוא הברכה וההבטחה שלנו: נוחות בגוף. הסטודיו שורש בתאילנד — ההכשרה והקצב מגיעים משם — והתפריט נשאר עיסוי תאילנדי בלבד: עיסוי מסורתי, עיסוי בשילוב שמנים, צוואר–גב–כתפיים, עיסוי ראש, ארבע ידיים, רגליים וכרית עשבים.",
      about_p2:
      ...
      t6_h: "עיסוי רגליים תאילנדי (נואד טאו)",
      t6_p:
        "שוקיים וכפות רגליים בכיסא נוח, לחץ וקווים בתאילנדית — בתוספת משחה תאילנדית או חבילה חמה כשזמין.",
      t7_h: "כרית עשבים וחום",
      t7_p:
        "שקית עשבים תאילנדית מחוממת לשרירים תפוסים, להקלה בעצימות ולשכבת ריח — לרוב בשילוב עם עיסוי.",
      prices_h2: "מחירון",
      prices_kicker: "תפריט עיסוי תאילנדי",
      prices_note: "כל המחירים בשקלים (₪). מומלץ לאשר מחיר עדכני בזימון.",
      ...
      r5_name: "עפרה · תלפיות",
      r5_text:
        "רק טיפולים תאילנדיים — בלי ערבוב סגנונות — וזה מורגש. כרית העשבים על הגב הייתה נפלאה עם העיסוי.",
      ...
      img_t6_alt: "רגליים בקערת השריה — ספא רגליים",
      img_t7_alt: "כדורי עשבים תאילנדיים בעיסוי גב",
    },
    th: {
      ...
      t6_h: "นวดเท้าไทย",
      t6_p:
        "น่องและเท้าบนเก้าอี้สบาย แรงกดและเส้นทางแบบไทย — พร้อมยาหม่องไทยหรือประคบอุ่น",
      t7_h: "ประคบสมุนไพรและความร้อน",
      t7_p:
        "ลูกประคบสมุนไพรไทยอุ่นๆ ช่วยคลายกล้ามเนื้อ ลดความตึง และเพิ่มกลิ่นหอม — มักจับคู่กับนวด",
      prices_h2: "ราคา",
      prices_kicker: "เมนูนวดไทย",
      prices_note: "ราคาเป็นชีเกล (₪) กรุณายืนยันราคาล่าสุดเมื่อจอง",
      ...
      img_t6_alt: "แช่เท้าในชาม — สปาเท้าไทย",
      img_t7_alt: "ประคบสมุนไพรนวดหลัง",
    },
  };
