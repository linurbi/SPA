...
(function (global) {
  ...
  var T = {
    en: {
      ...
      phone_spa_tel: "+972559906352",
      phone_spa_display: "055-990-6352",
      manager_ann: "Ann",
      ...
      gift_cards_note: "Treatment gift vouchers available — contact us by phone or email.",
      lbl_website: "Website",
    ...
    he: {
      ...
      meta_desc:
        "עיסוי תאילנדי וספא תאילנדי בלבד — Sabai Dee, רחוב בן סירא 3 ירושלים. עיסוי מסורתי, בשילוב שמנים. זימון 055-990-6352 · sabaidee.co.il",
      ...
      phone_haim_tel: "+972548132322",
      phone_haim_display: "054-813-2322",
      lbl_gift_cards: "כרטיסיית מתנה",
      gift_cards_note: "אפשרות לרכישת כרטיסיית מתנה / שובר לטיפול — לפרטים התקשרו או כתבו לנו.",
      lbl_website: "אתר",
      site_link: "sabaidee.co.il",
      contact_email: "spa@sabaidee.co.il",
      form_name: "שם",
      ...
      visit_note:
        "ספא תאילנדי במרכז ירושלים — בן סירא 3, ליד העיר העתיקה. עיסוי תאילנדי, זימון תורים בטלפון 055-990-6352.",
    ...
    th: {
      ...
      phone_haim_tel: "+972548132322",
      phone_haim_display: "054-813-2322",
      lbl_gift_cards: "บัตรของขวัญ",
      gift_cards_note: "มีบัตรของขวัญสำหรับทรีตเมนต์ — ติดต่อทางโทรศัพท์หรืออีเมล",
